...
from hubnado.design import HubDesign, HubFiles, HubGenerator
from hubnado.utils import OptionEatAll


@click.group()
def cli():
    """Hubnado: A tool for generating UCSC track hubs
    Hubnado go BRRRR!
    """
...
def merge(*args, **kwargs):
    ...
    This requires that the hubs were created with the hubnado create command and that the hub designs were saved using the --save-hub-design option.
    """
